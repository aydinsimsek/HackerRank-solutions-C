...
int main() {
    ...
    for (i=0; i<=length-1; i++){
       ...
       else if (*(num + i) == '2') {count2++;}
       else if (*(num + i) == '3') {count3++;}
       else if (*(num + i) == '4') {count4++;}
       else if (*(num + i) == '5') {count5++;}
       else if (*(num + i) == '6') {count6++;}
       else if (*(num + i) == '7') {count7++;}
       else if (*(num + i) == '8') {count8++;}
       else if (*(num + i) == '9') {count9++;}
    }
